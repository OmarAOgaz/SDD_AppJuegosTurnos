# Build release APK once and install on all connected Android devices.
# Run from repo root: .\scripts\deploy-release.ps1
# Optional: .\scripts\deploy-release.ps1 -DeviceId "SERIAL"
...
foreach ($d in $devices) {
  Write-Host "Installing release on $d ..."
